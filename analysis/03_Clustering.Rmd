...
#JoinLayers() is not compatible with SCT Assay
DefaultAssay(data.combined) <- "RNA"
data.combined <- JoinLayers(data.combined)

# SCT Assay creates multiple models and that needs to be corrected to retain only recorrected counts before finding markers
DefaultAssay(data.combined) <- "SCT"
PrepSCTFindMarkers(data.combined, assay = "SCT", verbose = TRUE)
