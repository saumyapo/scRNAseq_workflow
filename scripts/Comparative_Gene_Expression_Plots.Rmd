...
```{r, results = FALSE, eval = FALSE, message = FALSE, warning = FALSE}
data.combined <- readRDS("data_filt_44_umap_29_clusters.RDS")
```
...
plot_expression_heatmap(data.combined, "STAT1")
plot_expression_heatmap(data.combined, c("STAT1", "IRF1", "ISG15"))
```
...
# Running function for single gene and multiple genes
plot_expression_dotplot(data.combined, "STAT1") 
plot_expression_dotplot(data.combined, c("STAT1", "IRF1", "ISG15"))
```
...
# Running function for single gene and multiple genes
plot_expression_violin_seurat(data.combined, "STAT1")
plot_expression_violin_seurat(data.combined, c("STAT1", "IRF1"))
```
