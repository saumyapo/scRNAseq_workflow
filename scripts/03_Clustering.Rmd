---
title: "Immune 44 Samples HIV vs Control Clustering"
author: "Saumya"
date: "`r Sys.Date()`"
output:
  html_document:
...
# `r colorize('Clustering for 44 Immune samples ', 'blue')`
...
# Do clustering
# data.combined <- FindNeighbors(data.combined, reduction = "harmony", dims = 1:50)
...
# # Save markers
# write.csv(data.markers, file='../csvs/data_44_all_markers_33_clusters.csv')
```
...
```{r, echo=FALSE, message=FALSE, warning=FALSE}
# Read Markers .csv
data.markers = read.csv('../csvs/data_44_all_markers_33_clusters.csv')
...
positive.markers = read.csv('../csvs/data_44_all_markers_33_clusters.csv')
...
write.csv(positive.markers, file='../csvs/data_44_pos_markers_33_clusters.csv')
...
#                          "12" = "Stroma",
#                          "13" = "Glial cells",
#                          "14" = "classic monocytes",
#                          "15" = "Macrophages",
#                          "16" = "Plasma cells",
#                          "17" = "Plasma cells",
#                          "18" = "Stroma",
#                          "19" = "classic monocytes",
#                          "20" = "T cells",
...
# 
# saveRDS(data.combined, "../RDS/data_44_umap_33_clusters.RDS")
```
